/*
 * Paparazzi $Id: pprz_transport.h 4192 2009-09-19 18:25:22Z hecto $
 *  
...
#define ReadPprzBuffer() { PprzLink(NonBlockRead()); while (PprzLink(ChAvailable())&&!pprz_msg_received) parse_pprz(PprzLink(Getch())); }
